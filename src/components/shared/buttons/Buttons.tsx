...
const Buttons = (props: ButtonProps) => {
    ...
    return (
        <div>
            <button type={type} className={`bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium ${className}`}>{text}</button>
